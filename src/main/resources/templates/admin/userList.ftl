...
<div class="panel">
    <div class="panel-body">
        <form class="form-horizontal" action="/rmxg_blog/user/list" method="get">
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <a href="/rmxg_blog/user/list" class="btn btn-success">查询全部</a>
                </div>
            </div>
        </form>
    </div>
        ...
        <div class="panel-body" style="padding: 0;">
            <div class="col-sm-12" style="padding: 0;text-align: center;">
                <ul class="pager" style="margin-top: 10px;margin-bottom: 10px;">
                    ...
                    <#if userPage.pageNum lte 1>
                        <li class="previous disabled">
                            <a href="javascript:void(0)"><i class="icon-chevron-left"></i></a>
                        </li>
                    <#else>
                        <li class="previous" onclick="getNewData('${userPage.pageNum-1}')">
                            <a href="javascript:void(0)"><i class="icon-chevron-left"></i></a>
                        </li>
                    </#if>
                    <li>
                        <a href="javascript:void(0)" class="btn">
                            ${userPage.pageNum}页/共${userPage.total}</a>
                    </li>
                    <#if userPage.pageNum gte userPage.total>
                        <li class="next disabled">
                            <a href="javascript:void(0)"><i class="icon-chevron-right"></i></a>
                        </li>
                    <#else>
                        <li class="next" onclick="getNewData('${userPage.pageNum+1}')">
                            <a href="javascript:void(0)"><i class="icon-chevron-right"></i></a>
                        </li>
                    </#if>
                    <li class="previous" onclick="getNewData('${userPage.total}')">
...
<div class="modal fade" id="userUpdateModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="/rmxg_blog/user/update" method="post">
...
<script type="text/javascript">
    ...
    function getNewData(pageNum) {
        ...
        window.location.href = "/rmxg_blog/admin/userList?pageNum=" + pageNum + "<#if (userName?? && userName?length>0)>&userName=${userName!}</#if>";
    }
