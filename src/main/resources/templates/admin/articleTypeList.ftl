                            ...
                            <table class="table">
                                ...
                                <#list articleType0List as articleType>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/rmxg_blog/article/type/list?articleTypeParentId=${(articleType.articleTypeId)}">
...
<script type="text/javascript">
    ...
    function articleUpdateAction() {
        ...
        $.post("/rmxg_blog/article/type/addOrUpdate", {
    ...
    function delArticleType(articleTypeId) {
        if (confirm("是否删除")) {
            ...
            $.post("/rmxg_blog/article/type/del", {
                    articleTypeId: articleTypeId
                },
                function (data) {
                    if (data.code == 200) {
