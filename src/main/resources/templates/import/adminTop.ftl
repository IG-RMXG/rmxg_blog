...
<nav class="navbar navbar-default" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/rmxg_blog/admin/index" target="_blank"><i class="icon-home"></i> 首页</a>
        </div>
        <div class="collapse navbar-collapse navbar-collapse-example">
            <ul class="nav navbar-nav">
                <li><a href="/rmxg_blog/"><i class="icon-list-ol"></i> 基础数据</a></li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-group"></i> 用户管理<b
                                class="caret"></b></a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="/rmxg_blog/user/list">用户列表</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-th-list"></i> 文章管理<b
                                class="caret"></b></a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="/rmxg_blog/article/type/list">文章类型</a></li>
                        <li><a href="/rmxg_blog/article/tag/list">文章标签</a></li>
                        <li><a href="/rmxg_blog/article/list">文章管理</a></li>
                    </ul>
                </li>
                <li><a href="/rmxg_blog/ad/list"><i class="icon-dollar"></i> 广告管理</a></li>
                <li><a href="/rmxg_blog/link/list"><i class="icon-smile"></i>友情连接</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="/rmxg_blog/logout"><i class="icon-signout"></i> 退出登陆</a></li>
                    </ul>
                </li>
...
<script>
    ...
    function updatePassword() {
        $.post("/rmxg_blog/password/update", {
